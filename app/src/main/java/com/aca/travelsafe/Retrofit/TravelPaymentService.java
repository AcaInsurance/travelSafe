...
public class TravelPaymentService {
    ...
    public static Retrofit.Builder createService(final RequestBody body)  {
        ...
        Retrofit.Builder builder = new Retrofit.Builder()
                ...
                .baseUrl(UtilService.wsPaymentURL);
    ...
    public static ExchangeRateAPI createExRateService(final RequestBody body) {
        Retrofit.Builder builder = createService(body);
        return builder.build().create(ExchangeRateAPI.class);
    }
}
